...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route exact path="welcome" element={<Wizard routes={WelcomeWizardConstructorRoutes} rootRoute={"/welcome"} defaultState={defaultWelcomeWizardState} finalAction={finalAction}/>}>
